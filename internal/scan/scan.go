...
// Derived from InlineScanner, the winner of a five-way performance comparison
...
const (
	...
	RightBrack      // ']'
	RightBrace      // '}'
	CharLiteral     // unused; kept so type_string.go stays valid

	// The following constants preserve the numeric values generated by
	// `stringer -type Type` and must not be reordered.
	Assign         // unused
	Char           // character literal, e.g. #\space
	GreaterOrEqual // unused
	Identifier     // unused
	Number         // unused
	Operator       // unused
	Op             // unused
...
//	#\x                         (any other single character, including Unicode)
